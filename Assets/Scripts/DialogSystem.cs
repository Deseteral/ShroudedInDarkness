...
public static class Dialogs
{
    public static DialogLine[] Intro = {
        ...
        new DialogLine("p", "I'm going to find those."),
        new DialogLine("x", "Will they protect us?"),
        new DialogLine("p", "Yes, with a little bit of luck the fire from those magic branches will exile those monsters."),
        new DialogLine("x", "Exile them? Is it possible? We could go back to our old lifes?"),
        new DialogLine("p", "We shall see..."),
        new DialogLine("p", "I'm going to go now."),
    ...
    public static DialogLine[] BlueFire = {
        ...
        new DialogLine("p", "The Old Fire Magic... I think I can cast fire now..."),
